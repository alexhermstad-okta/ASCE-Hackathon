...
HIPCHAT_SERVER="hipchat.atko.biz"
...
# If you use a different backend, make sure to add their required settings.  # STORAGE_BACKEND = ""  # "redis", "couchbase", or "local".  # Disable SSL checks.  Strongly recommended this is not set to True.
# ALLOW_INSECURE_HIPCHAT_SERVER = True
